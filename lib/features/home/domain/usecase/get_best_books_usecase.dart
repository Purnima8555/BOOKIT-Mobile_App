...
class GetBestBooksUsecase implements UsecaseWithoutParams<List<HomeEntity>> {
  final IHomeRepository _homeRepository;

  GetBestBooksUsecase({required IHomeRepository homeRepository})
      : _homeRepository = homeRepository;

  @override
  Future<Either<Failure, List<HomeEntity>>> call() {
    return _homeRepository.getBestBooks();
  }
}
