...
class GetNewBooksUsecase implements UsecaseWithoutParams<List<HomeEntity>> {
  final IHomeRepository _homeRepository;

  GetNewBooksUsecase({required IHomeRepository homeRepository})
      : _homeRepository = homeRepository;

  @override
  Future<Either<Failure, List<HomeEntity>>> call() {
    return _homeRepository.getNewBooks();
  }
}
